...
class ForestFireEnv0(gym.Env):
    ...
    maker_params = {'env_mode': 'stochastic',
                 'n_row': 16, 'n_col': 16, 'p_tree': 0.0100, 'p_fire': 0.005,
                 'init_pos_row': None, 'init_pos_col': None,
                 'termination_type': 'steps', 'reward_type': 'ratio', 'observation_mode': 'plain'}
    ...
    init_cell_probs = {'ip_tree': 0.6, 'ip_empty': 0.4, 'ip_fire': None, 'ip_rock': 0.00, 'ip_lake': None}
